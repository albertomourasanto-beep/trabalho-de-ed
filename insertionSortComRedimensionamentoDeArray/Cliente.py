...
class App:
    ...
    def _build_ui(self):
        ...
        btn("⚡  Ordenar",          self.ordenar,         0, 1, ACENTO)
        btn("📋  Listar Original",  self.listar_original, 0, 2)
        btn("✅  Listar Ordenado",  self.listar_ordenado, 1, 0)
        btn("📊  Estatísticas",     self.estatisticas,    1, 1)
        btn("📈  Gráfico",          self.mostrar_grafico, 1, 2, VERDE)
        btn("✖  Sair",             self.root.quit,       2, 1, VERMELHO)
